...
**Актуальная информация о деплое:**

- **Фронтенд:** Cloudflare Pages (`wrangler pages deploy`)
- **Бэкенд:** Cloudflare Workers (`wrangler deploy`)
...
**⚠️ Устаревшее:** Netlify, Vercel, Fly.io для фронтенда больше не используются.
