...
const translations = {
  ru: {
    ...
    referral_list_empty: 'Пока никого не пригласили',
    referral_level_short: 'Уровень {n}',
    referral_earned_points: '+{n} баллов',
    referral_invited: 'Приглашено друзей',
    referral_partner_cta: 'Достигай уровни — открой возможность стать партнёром и выводить доход.',
    referral_become_partner_btn: 'Стать партнёром и выводить доход',
    profile_referral_partner_hint: 'Баллы за друзей. Хочешь выводить доход — стань партнёром.',
    home_referral_title: 'Пригласи друзей и зарабатывай баллами',
    home_referral_subtitle: 'Поделись ссылкой — получай баллы с покупок друзей',
    home_referral_copy_btn: 'Скопировать ссылку',
    home_referral_share_btn: 'Поделиться',
    home_referral_more: 'Подробнее',
    home_referral_link_soon: 'Скоро здесь появится твоя ссылка',
    profile_referral_block_title: 'Заработок на рекомендациях',
    ...
    partner_category_group_required: 'Выберите тип бизнеса',
    partner_business_type_required: 'Выберите категорию услуг',
    ...
    karma_level_sprout: 'Росток',
    karma_level_reliable: 'Надёжный',
    karma_level_regular: 'Постоянник',
    karma_level_golden: 'Золотой',
    karma_to: 'до',
    karma_progress: 'Прогресс',
    karma_points_to_next: 'баллов до следующего уровня',
    karma_max_level: 'Максимальный уровень!',
    karma_max_reached: 'Золотой клиент сети',
    karma_tooltip_title: 'Ваша репутация в сети',
    ...
    profile_you_are_partner: 'Вы партнер',
    profile_partner_dashboard_description: 'Управляйте своим бизнесом, отслеживайте статистику и аналитику в партнерском дашборде.',
    profile_open_dashboard: 'Открыть дашборд',
  ...
  en: {
    ...
    referral_list_title: 'Invited Friends',
    referral_list_empty: 'No one invited yet',
    referral_level_short: 'Level {n}',
    referral_earned_points: '+{n} pts',
    referral_invited: 'Friends invited',
    referral_partner_cta: 'Reach new levels — unlock the option to become a partner and withdraw earnings.',
    referral_become_partner_btn: 'Become a partner and withdraw earnings',
    profile_referral_partner_hint: 'Points for friends. Want to withdraw earnings? Become a partner.',
    home_referral_title: 'Invite friends and earn points',
    home_referral_subtitle: 'Share your link — earn points from friends\' purchases',
    home_referral_copy_btn: 'Copy link',
    home_referral_share_btn: 'Share',
    home_referral_more: 'More',
    home_referral_link_soon: 'Your link will appear here soon',
    profile_referral_block_title: 'Earn from referrals',
    ...
    partner_category_group_required: 'Select business type',
    partner_business_type_required: 'Select service category',
    ...
    karma_level_sprout: 'Sprout',
    karma_level_reliable: 'Reliable',
    karma_level_regular: 'Regular',
    karma_level_golden: 'Golden',
    karma_to: 'to',
    karma_progress: 'Progress',
    karma_points_to_next: 'pts to next level',
    karma_max_level: 'Max level!',
    karma_max_reached: 'Golden client',
    karma_tooltip_title: 'Your network reputation',
    ...
    profile_you_are_partner: 'You are a Partner',
    profile_partner_dashboard_description: 'Manage your business, track statistics and analytics in the partner dashboard.',
    profile_open_dashboard: 'Open Dashboard',
