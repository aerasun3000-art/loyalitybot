        ...
        {chatId && (
          <div className="bg-jewelry-cream rounded-xl p-4 shadow-lg mb-4 border border-jewelry-gold/20">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="font-bold text-jewelry-brown-dark">{t('profile_referral_block_title')}</h3>
            </div>
            <p className="text-sm text-jewelry-gray-elegant mb-3">{t('profile_referral_partner_hint')}</p>
            {referralStats && (
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-jewelry-brown-dark text-sm font-medium">
            ...
            {referralStats && (
              <div className="grid grid-cols-2 gap-3 mb-3">
                <div className="text-center p-2 bg-white rounded-lg border border-jewelry-gold/20">
                  <div className="text-lg font-bold text-jewelry-gold">{referralStats.total_referrals || 0}</div>
                  <div className="text-xs text-jewelry-gray-elegant">{t('referral_invited')}</div>
                </div>
                <div className="text-center p-2 bg-white rounded-lg border border-jewelry-gold/20">
                  <div className="text-lg font-bold text-jewelry-gold">{referralStats.total_earnings || 0} 💸</div>
                  <div className="text-xs text-jewelry-gray-elegant">{t('referral_earned')}</div>
                </div>
              </div>
            )}
            {referralCode ? (
              <button
                ...
                className="w-full bg-jewelry-gold text-jewelry-cream py-2.5 rounded-lg font-semibold text-sm hover:bg-jewelry-gold-dark transition-colors flex items-center justify-center gap-2 mb-3"
              >
              ...
              <p className="text-sm text-jewelry-gray-elegant italic mb-3">{t('home_referral_link_soon')}</p>
            )}
            <div className="flex flex-wrap gap-2">
              <button
                onClick={() => { hapticFeedback('light'); navigate('/partner/apply'); }}
                className="flex-1 min-w-[140px] bg-jewelry-brown-dark text-white py-2 rounded-lg font-semibold text-sm hover:bg-jewelry-burgundy transition-colors"
              >
                {t('referral_become_partner_btn')} →
              </button>
              <button
                onClick={() => { hapticFeedback('light'); navigate('/community'); }}
                className="px-4 py-2 text-jewelry-brown-dark text-sm font-medium hover:underline"
              >
                {t('home_referral_more')} →
              </button>
            </div>
            {referralToast && (
              <div className="fixed bottom-24 left-1/2 -translate-x-1/2 bg-jewelry-brown-dark text-white px-4 py-2 rounded-lg text-sm shadow-lg z-50">
                {referralToast}
              </div>
            )}
          </div>
